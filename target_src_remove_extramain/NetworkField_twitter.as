package network.field{
	...
	import network.component.HumanNodeBase_twitter;
    ...
    public class NetworkField_twitter extends TmbField{
		...
		*/
		...
		{	
			...
			var hn:HumanNodeBase_twitter = new HumanNodeBase_twitter();
			hn.name = "hnb-" + obj._id;
			hn._obj = obj;
			hn._link = links;
			...
			if (hn._obj.depth != 0) {
				...
				//if (0){
					...
					var rad = Math.PI * 2 * (this._test_count * 2 % n) / n;
		...
		*/
		...
		public function moveCenter(nb:HumanNodeBase_twitter)
		{
			this.stopAll();
			var hid = nb._obj._id;
